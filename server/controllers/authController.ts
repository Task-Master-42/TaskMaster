...
const authController = {
  ...
  handleUserDetails: async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      next({
        log: error,
        message: { error: 'Error occurred handling user details.' },
      });
    }
  },
  ...
  login: async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      next({
        log: error,
        message: { error: 'Error occurred in login.' },
      });
    }
  },
  ...
  signup: async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      next({
        log: error,
        message: { error: 'Error occurred in signup.' },
      });
    }
  },
  ...
  startSession: async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      if (valid) {
        ...
        // Store hashed ID onto profile !!! store board onto profile !!!
      ...
      next({
        log: error,
        message: { error: 'Error occurred in starting session.' },
      });
    }
  },
  ...
  isLoggedIn: async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      next({
        log: error,
        message: { error: 'Error occurred in checking cookie.' },
      });
    }
  },
